...
routeruser.get("/name/dydo", async (req,res)=>{
    try {
        const {dt}= req.body;
        const admindata =await registerdata.find({PEON:"Approved"}).sort({name:1});
        res.status(200).json({admindata});
    } catch (error) {
        res.status(500).json({status:500,error:error.message})
    }
...
routeruser.get("/time/dydo", async (req,res)=>{
    try {
        const {dt}= req.body;
        const admindata =await registerdata.find({PEON:"Approved"}).sort({fulltime:1});
        res.status(200).json({admindata});
    } catch (error) {
        res.status(500).json({status:500,error:error.message})
    }
...
routeruser.get("/name/commisioner", async (req,res)=>{
    try {
        const {dt}= req.body;
        const admindata =await registerdata.find({officer:"Approved"}).sort({name:1});
        res.status(200).json({admindata});
    } catch (error) {
        res.status(500).json({status:500,error:error.message})
    }
...
routeruser.get("/time/commisioner", async (req,res)=>{
    try {
        const {dt}= req.body;
        const admindata =await registerdata.find({officer:"Approved"}).sort({fulltime:1});
        res.status(200).json({admindata});
    } catch (error) {
        res.status(500).json({status:500,error:error.message})
    }
