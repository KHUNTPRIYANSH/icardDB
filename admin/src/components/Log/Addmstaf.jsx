          ...
          <div className="data">
            ...
            <form action="#">
              ...
              <div style={{display:`${isopen?"unset":"none"}`}}>
                <p style={{cursor:'pointer'}} onClick={()=>{setRole("eventStaf"); setIsopen(false) }}>EventStaf</p>
                <p style={{cursor:'pointer'}} onClick={()=>{setRole("hospital"); setIsopen(false) }}>Hospital</p>
                <p style={{cursor:'pointer'}} onClick={()=>{setRole("busStation"); setIsopen(false) }}>BusStation</p>
                <p style={{cursor:'pointer'}} onClick={()=>{setRole("railwayStation"); setIsopen(false) }}>RailwayStation</p>
              </div>
              <br />
              <h3>Id</h3>
              <input value={id} onChange={(e)=>{setId(e.target.value)}} type="text" placeholder="abcd123@xyz.com" />
              <h3>MobileNo</h3>
              <input value={mobile} onChange={(e)=>{setMobile(e.target.value)}} type="text" placeholder="Enter mobile No" />
              <h3>Password</h3>
